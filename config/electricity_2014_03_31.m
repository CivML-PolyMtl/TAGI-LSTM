%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File:         Electricity_2014_03_31
% Description:  Electricity_2014_03_31
...
batchSize = 4;
nb_tsPar = 42;  % number of time series running in parallel using parfor function
...
% Display results
p50 = mt.computeND(y(testIdx,:),ytestPd)
p90 = mt.compute90QL (y(testIdx,:), ytestPd(:,:), SytestPd(:,:))
RMSE = mt.computeRMSE(y(testIdx,:), ytestPd)

% save results
% save('electricity_2014_03_31','ytestPd','SytestPd','initSeed')
