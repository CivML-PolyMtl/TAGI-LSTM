%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File:         Sine wave
% Description:  Apply TAGI to predict electricity dataset
...
save('traffic_last_ensemFix05','y','t','ytestPd','SytestPd','initSeed','epoch_optim','testIdx','tsIdx','net','netT','ytestPd_cell','SytestPd_cell')
