...
% 
t = t(1:4169); % 01-01-2008 to 21-06-2008
y = y(1:4169,:);
...
save('traffic_mid_ensemFix05','y','t','ytestPd','SytestPd','initSeed','epoch_optim','testIdx','tsIdx','net','netT','ytestPd_cell','SytestPd_cell')
